...
//         <button className="bg-red-500 flex ms-3  text-white py-2 px-4 rounded-md shadow hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50">
//           Report User
//           </button>
//       </div>
...
const UserDetails: React.FC<prop> = ({
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4">
      ...
      {isModalOpen && (
        <ReportModal isOpen={isModalOpen} onClose={handleCloseModal} onReport={handleReportUser} userId={id}/>
      )}
    </div>
  );
};
